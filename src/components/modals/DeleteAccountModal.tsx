        ...
        <div className="p-6">
          ...
          <div className="mb-6">
            ...
            <input
              ...
              disabled={isDeleting}
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 disabled:opacity-50 disabled:cursor-not-allowed"
