      ...
      {status === 'active' && url && (
        <div className="mb-3 flex gap-2">
          <button
            ...
            className="flex-1 px-4 py-2 bg-gray-900 text-white rounded-lg hover:bg-gray-700 transition-colors text-sm font-medium flex items-center justify-center gap-1.5"
          >
