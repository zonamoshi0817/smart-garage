...
function Header() {
  return (
    <header className="sticky top-0 z-40 bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/60 border-b border-gray-100">
        ...
        <div className="flex items-center gap-3">
          <button disabled className="hidden sm:inline-flex px-3 py-2 rounded-xl border border-gray-200 text-gray-400 cursor-not-allowed">準備中</button>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="mt-10 grid md:grid-cols-2 gap-6">
          ...
          <div className="relative rounded-2xl border border-blue-200 bg-white p-6 shadow-[0_10px_30px_rgba(37,99,235,0.08)]">
            ...
            <button disabled className="mt-6 inline-flex items-center justify-center w-full rounded-xl bg-gray-200 text-gray-400 py-2.5 cursor-not-allowed">近日公開</button>
            <p className="mt-2 text-xs text-gray-500 text-center">サービス準備中です。もうしばらくお待ちください。</p>
          </div>
        </div>
      </div>
    </section>
        ...
        <div className="rounded-3xl bg-white/10 ring-1 ring-white/20 p-8 lg:p-10 text-white backdrop-blur">
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:justify-end">
              <button disabled className="inline-flex items-center justify-center gap-2 rounded-2xl bg-gray-100 text-gray-400 font-semibold px-6 py-3 cursor-not-allowed">
                近日公開
              </button>
            </div>
            </div>
