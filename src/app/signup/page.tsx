  ...
  const handleEmailSignUp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (errorCode === "auth/email-already-in-use") {
        ...
        errorMessage = "パスワードが弱すぎます。6文字以上の強力なパスワードを設定してください";
        setIsEmailAlreadyInUse(false);
      ...
      if (process.env.NODE_ENV === 'development') {
        console.log("Signup error handled:", errorCode, "- Message shown to user:", errorMessage);
      }
          ...
          <div className="bg-red-50 border-l-4 border-red-400 p-4 rounded">
            ...
            {isEmailAlreadyInUse && (
              <p className="text-sm text-red-600">
                既にアカウントをお持ちの場合は、
                <Link href="/login" className="text-blue-600 hover:text-blue-700 underline font-medium ml-1">
                  こちらからログイン
                </Link>
                してください。
              </p>
